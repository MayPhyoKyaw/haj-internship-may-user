        ...
        <nav class="navbar">
            <ul className="nav nav-tabs">
                <li className="nav-item">
                    <button className="nav-link active" data-toggle="tab" href="#home">User Information</button>
                </li>
                <li className="nav-item">
                    <button className="nav-link" data-toggle="tab" href="#login">Change Password</button>
                </li>
            </ul>
        </nav>
